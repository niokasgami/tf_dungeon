...
export class ColorFilter extends Filter {
    ...
    /**
     * Sets the hue for the ColorFilter.
     *
     * @method setHue
     * @param {number} hue - Hue value to set on the ColorFilter. The hue should be a valid JavaScript number.
     */
    setHue(hue: number) {
    ...
    setColorTone(tone: number[]) {
        ...
        this.uniforms.colorTone = tone.slice(0);
    }
    ...
    setBlendColor(color: number[]) {
        ...
        this.uniforms.blendColor = color.slice(0)
    }
